...
M_1 = np.kron(np.kron(np.eye(2 ** 2), Z.matrix()), np.eye(2 ** 1))
M_3 = np.kron(Z.matrix(), np.eye(2 ** 3))
M_4qubit = M_1 - M_3

M_7 = np.kron(M_3, np.eye(2 ** 4))
M_3 = np.kron(np.eye(2 ** 4), M_3)
M_8qubit = M_3 - M_7

M_5 = np.kron(np.kron(np.eye(2 ** 6), Z.matrix()), np.eye(2 ** 5))
M_11 = np.kron(Z.matrix(), np.eye(2 ** 11))
M_12qubit = M_5 - M_11
