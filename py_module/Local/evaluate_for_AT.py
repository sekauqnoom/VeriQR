...
def generate_newdata_for_adversarial_training():
    ...
    if '.npz' in str(argv[1]):
        ...
        for noise_type in noise_types:
            ...
            final_kraus, _ = generate_circuit_with_specified_noise(Circuit(), kraus,
        ...
        random_circuit, random_kraus = generate_circuit_with_random_noise(origin_circuit, model_name,
                                                                            True, file_name + '.svg')
        ...
        for noise_type in noise_types:
            ...
            final_kraus, _ = generate_circuit_with_specified_noise(random_circuit, random_kraus,
                                                                  noise_type, noise_list,
                                                                  kraus_file, p, model_name,
                                                                  True, file_name + '.svg')
